            ...
            return (
              <Stap key={s.key} s={s} toestand={toestand}>
                ...
                {s.key === "reply" && i <= stap && reply && (
                  <div className="animate-fadeIn rounded-md bg-hover border border-line px-3 py-2 text-muted whitespace-pre-line max-h-24 overflow-hidden">
      ...
      <div className="flex-1 pb-4 min-w-0">
        <div
          className={`text-sm font-medium ${
            toestand === "wacht" ? "text-faint" : "text-ink"
          }`}
        >
          {t(s.titelKey)}
          {toestand === "actief" && (
